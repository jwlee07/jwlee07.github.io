...
[이전 글](https://jwlee07.github.io/posts/early-startup-package-1/)에서 초기창업패키지가 무엇인지 알아봤어요.

이번 글에서는 초기창업패키지 사업계획서 작성법을 알아볼게요. 사업계획서는 제풀 서류 중 가장 중요한 부분이에요. 지원 선정 여부를 결정하기 때문이에요.

사업계획서의 주요 항목에 대해서 살펴볼게요.

## 1. 작성 항목
---
사업계획서는 정해진 양식이 있어요. 모든 항목을 빠짐없이 작성해야 해요.
...
객관적인 데이터(시장 리포트, 통계 등)을 활용하면 설득력이 높아져요.
...
단기(협약 기간 내)와 장기(협약 종료 후)의 성장 전략을 구체적으로 제시하면 좋아요.
...
대표자와 팀원이 맡고 있는 역할과 강점을 구체적으로 설명하면 평가에서 높은 점수를 받을 수 있어요.
...
사업비 구성 계획을 상세히 작성하고 예산이 합리적으로 편성되었음을 강조하는 것이 중요해요.

### 2-2. 일반현황
---
기업과 창업아이템에 대한 기본 정보를 작성하는 부분이에요.
...
기업 정보는 공식적인 자료와 일치하도록 정확하게 기재해야 해요.

### 2-3. 창업아이템 개요(요약)
---
사업계획서의 핵심 내용을 한눈에 볼 수 있도록 요약하는 부분이에요.
